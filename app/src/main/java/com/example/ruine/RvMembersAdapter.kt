...
class RvMembersAdapter( var Memberlist: ArrayList<RvMembersModel>,val DataCarrier:DataBridge):RecyclerView.Adapter<RvMembersAdapter.MyviewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RvMembersAdapter.MyviewHolder {
    ...
    override fun onBindViewHolder(holder: RvMembersAdapter.MyviewHolder, position: Int) {
